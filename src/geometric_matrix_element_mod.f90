module geometric_matrix_element_mod
	implicit none
	private
    public  :: calculate_finite_geometric_matrix_element, calculate_infinite_geometric_matrix_element, calculate_infinite_parallel_geometric_matrix_element, calculate_infinite_J
...
contains
	...
	subroutine calculate_infinite_geometric_matrix_element(iKcm1, iKcm2, cnt_1, cnt_2, theta, c2c_distance, geometric_matrix_element)
		use cnt_class, only: cnt
		...
		if ((iKcm1 .ne. 0) .and. (iKcm2 .ne. 0)) then
			...
			do iPhi1 = 1,nPhi1
				do iPhi2 = 1,nPhi2
					...
					geometric_matrix_element = geometric_matrix_element + exp(i1*dcmplx(-2.d0*dble(cnt_1%selected_exciton%mu_cm)*phi1(iPhi1)+2.d0*dble(cnt_2%selected_exciton%mu_cm)*phi2(iPhi2))) * exp(i1*dcmplx(arg2)) * dcmplx(exp(-arg3 * arg1))
				end do
			end do
...
! 		integer :: iKcm1, iKcm2
	...
	subroutine calculate_infinite_J(geometric_matrix_element, cnt_1, cnt_2, mu_cm1, iKcm1, mu_cm2, iKcm2, theta, c2c_distance)
	...
	end subroutine calculate_infinite_J
