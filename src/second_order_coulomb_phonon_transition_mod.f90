...
contains
	...
	subroutine calculate_second_order_transition_rates (cnt_1,cnt_2)
		...
		do t_ex_type = 2, 2
			...
			do i = 1, energy_mesh_size
				write(log_input,'(A, I0, A, I0)') "calculating second-order exciton scattering rates: ", i, " / ", energy_mesh_size
				...
				do ix1 = 1, i_exciton%nx
					...
					do j=1,n_initial_state
						...
						do ix2 = 1,f_exciton%nx
							do iKcm2 = f_exciton%iKcm_max, f_exciton%iKcm_max
		...
		scattering_rate = scattering_rate * f_exciton%dKcm / (2*pi*hb)
