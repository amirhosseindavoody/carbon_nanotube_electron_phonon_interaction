...
scattering_rate_emission = data[1:-2,:].T
scattering_rate_emission_total = data[-1,:].T
...
axes.plot(energy_mesh_emission, scattering_rate_emission_total, color="black", linewidth=5.0, linestyle="solid", marker="o", markersize=10.0)

axes.set_yscale('log')

# for i in range(0,scattering_rate_emission.shape[1]):
# 	axes.plot(energy_mesh_emission, scattering_rate_emission[:,i], linewidth=3.0, linestyle="solid", marker="")
#
